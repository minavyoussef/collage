...
public abstract class DatasetBase {
  public abstract OperationResult load(long seed, double trainingPercentage, double testingPercentage);
  public abstract ObservationsList getTrainingSet();
  public abstract ObservationsList getTestingSet();
}
