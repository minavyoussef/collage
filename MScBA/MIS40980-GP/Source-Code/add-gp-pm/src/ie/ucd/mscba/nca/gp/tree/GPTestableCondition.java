...
public interface GPTestableCondition {
  boolean evaluate() throws DetectorException;
  void bind(AnalyticsBaseTableRow observation) throws DetectorException;
  void unbind();
  GPTestableCondition cloneTestabilityPoint();
}
