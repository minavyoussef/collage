...
public class CueColemanLiauIndex extends Cue {
  ...
  public CueColemanLiauIndex() {
    super("ColemanLiauIndex", "Coleman Liau Index", "A readability test designed by Meri Coleman and T. L. Liau to gauge the understandability of a text", CueValueType.Real);
  }
  ...
  public void extractCue(Observationable observation) {
    ...
    setValue(readability.getReadabilityMetric(MetricType.COLEMAN_LIAU));
  }
