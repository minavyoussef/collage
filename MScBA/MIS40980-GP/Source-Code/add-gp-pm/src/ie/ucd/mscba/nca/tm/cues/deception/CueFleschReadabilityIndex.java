...
public class CueFleschReadabilityIndex extends Cue {
  ...
  public CueFleschReadabilityIndex() {
    super("FleschReadabilityIndex", "Flesch Readability Index", " A readability tests designed to indicate how difficult a reading passage in English is to understand", CueValueType.Real);
  }
  ...
  public void extractCue(Observationable observation) {
    ...
    setValue(readability.getReadabilityMetric(MetricType.FLESCH_READING));
  }
