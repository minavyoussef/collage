...
public class CueNumberOfSyllables extends Cue {
  public CueNumberOfSyllables() {
    super("NumberOfSyllables", "Number of Syllables", "Total number of syllables in a given observation", CueValueType.Index);
  }
  ...
  public void extractCue(Observationable observation) {
    ...
    setValue(readability.getReadabilityMetric(MetricType.SYLLABLES));
  }
