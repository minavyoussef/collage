...
public class CueSMOGReadability extends Cue {
  ...
  public CueSMOGReadability() {
    super("SMOGReadability", "SMOG Readability", "A readability that estimates the years of education needed to understand a piece of writing", CueValueType.Real);
  }
  ...
  public void extractCue(Observationable observation) {
    ...
    setValue(readability.getReadabilityMetric(MetricType.SMOG));
  }
