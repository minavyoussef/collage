...
public class CueSMOGReadabilityIndex extends Cue {
  ...
  public CueSMOGReadabilityIndex() {
    super("SMOGReadabilityIndex", "SMOG Readability Index", "A readability that estimates the years of education needed to understand a piece of writing", CueValueType.Real);
  }
  ...
  public void extractCue(Observationable observation) {
    ...
    setValue(readability.getReadabilityMetric(MetricType.SMOG_INDEX));
  }
